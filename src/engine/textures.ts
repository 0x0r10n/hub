...
const BASE_PATTERNS: Record<SpriteVariant, string[]> = {
  ...
  // Hooded/cloaked wanderer: pointed hood, flared full-width robe, no visible leg split.
  cloaked: [
    ".....11.....",
    "....1111....",
    "...112211...",
  ...
  // Tiny creature: small, centered, short overall silhouette with no arms/legs split.
  tiny: [
    "............",
    "............",
    "............",
  ...
  // Android: blocky robotic head with a wide visor band, side arm blocks, rectangular legs.
  android: [
    "...111111...",
    "...111111...",
    "..22222222..",
  ...
  // Mech: bulky armor with pauldron shoulders extending past the torso and thick boots.
  mech: [
    "....2222....",
    "....2222....",
    "...111111...",
  ...
  // Glitch: jagged, asymmetric silhouette with punched-out gaps -- reads as "corrupted".
  glitch: [
    "....222.....",
    "...222221...",
    "..2.1111....",
